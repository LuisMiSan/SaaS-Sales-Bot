    ...
    <div className="flex flex-col h-full overflow-y-auto">
      ...
      <div className="flex-1 p-6 max-w-2xl space-y-6">
        ...
        <div className="bg-card border border-border rounded-xl p-5 space-y-3">
          <div className="flex items-center gap-2">
            <span className="text-sm font-semibold">Integración n8n</span>
            <span className="text-[10px] font-bold uppercase tracking-widest bg-green-500/15 text-green-400 border border-green-500/30 px-2 py-0.5 rounded-full">Activa</span>
          </div>
          <p className="text-xs text-muted-foreground leading-relaxed">
            Los leads del formulario público se envían automáticamente al workflow de n8n en{" "}
            <span className="font-mono text-foreground">n8n.iadivisionmadrid.es</span>.
            n8n gestiona el envío de WhatsApp y cualquier automatización posterior.
          </p>
          <div className="text-xs text-muted-foreground bg-secondary/40 border border-border rounded-lg px-3 py-2.5 font-mono break-all">
            POST https://n8n.iadivisionmadrid.es/webhook/pujamostucoche-lead
          </div>
        </div>
