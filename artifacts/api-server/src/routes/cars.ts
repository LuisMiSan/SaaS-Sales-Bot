...
import { eq, desc, and, inArray, or, isNotNull, sql } from "drizzle-orm";
    ...
    try {
      ...
      const [car] = await db
        ...
        .values({
          ...
          co2: parsed.co2,
          consumptionUrban: parsed.consumptionUrban,
          consumptionHighway: parsed.consumptionHighway,
          consumptionMixed: parsed.consumptionMixed,
